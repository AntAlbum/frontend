<template>
  <div
    ...
    :class="totalSize === 0 ? 'images-container-empty' : 'images-container'"
  >
    <input
      class=""
      ref="images"
    ...
    <div class="image-upload" @click="alertUpload()" v-if="images.length > 0">
